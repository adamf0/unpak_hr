...
class CutiEntitas extends ICuti{
    public static function make($id=null,$nidn=null,$nip=null,?JenisCuti $jenis_cuti=null,$lama_cuti=null,Date $tanggal_mulai=null,?Date $tanggal_akhir=null,$tujuan=null,$dokumen=null,$catatan=null,$status=null){
        $instance = new self();
        $instance->id = $id;
        $instance->nidn = $nidn;
        $instance->nip = $nip;
