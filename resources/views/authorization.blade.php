                        ...
                        <form action="{{route('auth.authentication')}}" method="post">
                          ...
                          <div class="row gy-3 overflow-hidden">
                            ...
                            <div class="col-12 d-grid gap-5">
                              ...
                              <div class="row gap-3">
                                <a href="{{ Utility::loadAsset('USER GUIDE DOSEN & TENDIK NON STRUKTURAL (26-08-2024).pdf')}}" target="_blank" class="btn btn-primary btn-md col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">Manual Guide</a>
                                <a href="https://unpak.link/hrportal_app" target="_blank" class="btn btn-success btn-md col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6"><i class="bi bi-android2"></i> Versi Android</a>
                              </div>
                            </div>
                          </div>
                        </form>
