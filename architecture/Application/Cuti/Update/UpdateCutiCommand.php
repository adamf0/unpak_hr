...
class UpdateCutiCommand extends Command
{
    ...
    public function __construct($id,$nidn,$nip,?JenisCuti $jenis_cuti=null,$lama_cuti,Date $tanggal_mulai,?Date $tanggal_akhir=null,$tujuan,$dokumen,$status, public TypeData $option = TypeData::Entity) {
        $this->id = $id;
        $this->nidn = $nidn;
        $this->nip = $nip;
