        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('master_kalendar.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <x-input-text title="Tanggal Akhir" name="tanggal_berakhir" class="tanggal_berakhir" default="{{ old('tanggal_berakhir') }}"/>
                                    </div>
                                    <div class="col-12">
