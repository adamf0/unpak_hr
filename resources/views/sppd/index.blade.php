                ...
                modalBody.html(`
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>${rowData?.rencana_waktu_tindak_lanjut!=null || rowData?.rencana_waktu_tindak_lanjut!=undefined? Date.parse(rowData?.rencana_waktu_tindak_lanjut).toISOString():''}</td>
                        </tr>
                        <tr>
                            <td>Foto</td>
                            <td>:</td>
