...
class ButtonEditorInternalAsMemberState extends MappingHtmlOrmStateInterface{
    ...
    public function handle() {
        ...
        $this->output .= "
            <form action='".route('penelitianInternal.verificationMember')."' method='POST'>
                <input type='hidden' name='status' value='1'/>
                <input type='hidden' name='id_penelitian_internal' value='".$this->item->GetId()."'/>
