...
class GetAllSPPDByNIPQueryHandler extends Query
{
    ...
    {
        $datas = SPPDModel::with(['JenisSPPD','Dosen','Dosen.Fakultas','Dosen.Prodi','Pegawai','FileLaporan','PayrollPegawai','PayrollVerifikasi','EPribadi'])->where('nip',$query->GetNIP())->get();
